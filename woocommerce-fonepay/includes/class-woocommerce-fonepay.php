...
final class WooCommerce_Fonepay {
	 ...
	 *
	 * Locales found in:
	 *      - WP_LANG_DIR/woocommerce-fonepay/woocommerce-fonepay-LOCALE.mo
	...
	public function load_plugin_textdomain() {
		...
		load_textdomain( 'woocommerce-fonepay', WP_LANG_DIR . '/woocommerce-fonepay/woocommerce-fonepay-' . $locale . '.mo' );
